<x-auth-layout>
    ...
    <h2 class="center" style="text-align:center;">
        ...
        <form action="{{ route('register_vendor') }}" method="POST" autocomplete="off">
            @csrf
            ...
            <textarea class="fill_data" name="intro" id="" rows="5"></textarea>

            <label for="mobile">No. Telp</label>
            <input class="fill_data" type="number" name="mobile" id="mobile" required><br><br>
